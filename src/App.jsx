...
function App() {
  return (
    <main className="flex flex-col justify-center  items-center text-[13px] font-barlow bg-[hsl(214_17%_92%)] min-h-screen ">
      <article className="grid items-center justify-center grids-col-1 desk:grid-cols-3 desk:grid-rows-2 max-w-[70rem] gap-8">
        <div className="desk:col-span-2 desk:row-span-2 ">
          <div className="grid gap-4 desk:grid-cols-3">
            <div className="flex flex-col gap-4 bg-[hsl(263_55%_52%)] rounded-xl p-8  text-[hsl(214_17%_92%)] desk:col-span-2">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="text-[0.77rem] text-[hsl(0_0%_81%)]">
            ...
            <div className="flex flex-col gap-4 bg-[hsl(217_19%_35%)] rounded-xl  p-8 text-[hsl(214_17%_92%)] desk:max-w-[15rem] ">
              <div className="flex items-center gap-5">
                <img
                  src={jonathan}
          ...
          <div className="grid gap-4 desk:grid-cols-3">
            <div className="flex flex-col gap-4 bg-white rounded-xl  p-8 text-[hsl(214_17%_92%)] ">
              <div className="flex items-center gap-5">
                <img
                  src={jeanette}
                ...
                />
                <div>
                  <p className="text-gray-500">Jeanette Harmon</p>
                  <p className="text-gray-400">Verified Graduate</p>
                </div>
              </div>
              <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4 p-8   text-white bg-[hsl(219_29%_14%)] rounded-xl desk:col-span-2">
              <div className="flex items-center gap-5">
                <img
                  src={patrick}
                  alt="Patrick Profile"
        ...
        <div className="flex flex-col gap-4 bg-white rounded-xl   p-8 text-[hsl(214_17%_92%)]  desk:row-span-2 desk:max-w-[15rem] desk:m-0">
          <div className="flex items-center gap-5">
            <img
              src={kira}
              alt="Kira Profile"
            ...
            />
            <div>
              <p className="text-gray-500">Kira Whittle</p>
              <p className="text-gray-400">Verified Graduate</p>
            </div>
          </div>
          <div className="flex flex-col gap-5">
